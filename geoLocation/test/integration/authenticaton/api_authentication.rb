...
#####################################################################################
# Test Cases: (6)                                            Status:                #
#    - Authentication with valid API Key                    200, OK                 #
#    - Authentication with invalid API Key                  200, REQUEST_DENIED     #
#    - Authentication with bad API Key                      200, REQUEST_DENIED     #
#    - Authentication with no Key                           200, OK                 #
#    - Authenticaiton with http                             200, REQUEST_DENIED     #
#    - Authenticaiton with https                            200, OK                 #
#####################################################################################
